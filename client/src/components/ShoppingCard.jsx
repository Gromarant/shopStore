import { Logo, Image, LabelAmount, Counter } from '../atomComponents';

function ShoppingCard({id, logo, img, name, brand, labelOne, labelTwo, handle, count}) {
    return (
        <article className='card shopList'>
